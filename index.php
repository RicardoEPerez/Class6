...
<body class="container">
    ...
    <h6>Regresa el numero de caracteres "Hello world!"</h6>
    <?php
    ...
    <h6>Regresa el numero de palabras "Hello world!"</h6>
    <?php
    ...
    <h6>Regresa la palabras alrevez "Hello world!"</h6>
    <?php
    ...
    <h6>Busca una palabra y regresa la cantidad de caracteres que tiene como "world!" en "Hello world!"</h6> 
    <?php
        echo strpos("Hello world!", "world!"); // outputs 6, Si no ecuentra coincidencias regresa un "False"
    ?>

    <br><br>

    <h6>Remplaza una palabra por otra  "world" con "Dolly"</h6>
    <?php
